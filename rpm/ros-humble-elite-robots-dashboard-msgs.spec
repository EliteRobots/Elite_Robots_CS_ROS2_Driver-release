...
Name:           ros-humble-elite-robots-dashboard-msgs
Version:        1.0.3
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS elite_robots_dashboard_msgs package

License:        Apache-2.0
URL:            https://index.ros.org/p/elite_robots_dashboard_msgs/#humble
