...
Name:           ros-humble-elite-robots-msgs
Version:        1.0.3
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS elite_robots_msgs package

License:        Apache-2.0
URL:            https://index.ros.org/p/elite_robots_msgs/#humble
...
%description
Message and service definitions for interacting with Elite Robots robot
controllers.
