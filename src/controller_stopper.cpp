...
#include "elite_robots_driver/controller_stopper.hpp"
...
ControllerStopper::ControllerStopper(const rclcpp::Node::SharedPtr& node, bool stop_controllers_on_startup)
    ...
    dashboard_robot_mode_srv_ = node->create_client<elite_robots_msgs::srv::GetRobotMode>("dashboard_client/robot_mode");
    ...
    auto robot_mode_request = std::make_shared<elite_robots_msgs::srv::GetRobotMode::Request>();
    ...
    if (robot_mode != elite_robots_msgs::msg::RobotMode::POWER_ON &&
        robot_mode != elite_robots_msgs::msg::RobotMode::IDLE &&
        robot_mode != elite_robots_msgs::msg::RobotMode::RUNNING) {
