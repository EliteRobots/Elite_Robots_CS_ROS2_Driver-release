...
#include "elite_robots_msgs/msg/io_state.hpp"
#include "elite_robots_msgs/msg/tool_data.hpp"
#include "elite_robots_msgs/msg/robot_mode.hpp"
#include "elite_robots_msgs/msg/safety_mode.hpp"
#include "elite_robots_msgs/srv/set_io.hpp"
#include "elite_robots_msgs/srv/set_speed_slider_fraction.hpp"
#include "elite_robots_msgs/srv/set_payload.hpp"
...
#include <elite_robots_controllers/gpio_controller_parameters.hpp>
...
private:
    ...
    bool setIO(elite_robots_msgs::srv::SetIO::Request::SharedPtr req, elite_robots_msgs::srv::SetIO::Response::SharedPtr resp);

    bool setSpeedSlider(elite_robots_msgs::srv::SetSpeedSliderFraction::Request::SharedPtr req,
                        elite_robots_msgs::srv::SetSpeedSliderFraction::Response::SharedPtr resp);
    ...
    bool setPayload(const elite_robots_msgs::srv::SetPayload::Request::SharedPtr req, elite_robots_msgs::srv::SetPayload::Response::SharedPtr resp);
   ...
   protected:
    ...
    rclcpp::Service<elite_robots_msgs::srv::SetSpeedSliderFraction>::SharedPtr set_speed_slider_srv_;
    rclcpp::Service<elite_robots_msgs::srv::SetIO>::SharedPtr set_io_srv_;
    rclcpp::Service<elite_robots_msgs::srv::SetPayload>::SharedPtr set_payload_srv_;
    rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr tare_sensor_srv_;

    std::shared_ptr<rclcpp::Publisher<elite_robots_msgs::msg::IOState>> io_pub_;
    std::shared_ptr<rclcpp::Publisher<elite_robots_msgs::msg::ToolData>> tool_data_pub_;
    std::shared_ptr<rclcpp::Publisher<elite_robots_msgs::msg::RobotMode>> robot_mode_pub_;
    std::shared_ptr<rclcpp::Publisher<elite_robots_msgs::msg::SafetyMode>> safety_mode_pub_;
    std::shared_ptr<rclcpp::Publisher<std_msgs::msg::Bool>> task_state_pub_;

    elite_robots_msgs::msg::IOState io_msg_;
    elite_robots_msgs::msg::ToolData tool_data_msg_;
    elite_robots_msgs::msg::RobotMode robot_mode_msg_;
    elite_robots_msgs::msg::SafetyMode safety_mode_msg_;
