...
def launch_setup(context, *args, **kwargs):
    ...
    script_filename = PathJoinSubstitution(
        [FindPackageShare("elite_robots_driver"), "resources", "external_control.script"]
    )
    input_recipe_filename = PathJoinSubstitution(
        [FindPackageShare("elite_robots_driver"), "resources", "input_recipe.txt"]
    )
    output_recipe_filename = PathJoinSubstitution(
        [FindPackageShare("elite_robots_driver"), "resources", "output_recipe.txt"]
    )
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="elite_robots_driver",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="elite_robots_description",
